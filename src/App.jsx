      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"0 48px 60px"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:20,marginBottom:64}}>
          {PHOTOS_EMPAQUE.map((photo,i)=>(
            photo
              ? <img key={i} src={photo} alt={`Empaque ${i+1}`} style={{width:"100%",height:435,objectFit:"cover",objectPosition:i===0||i===2?"center top":"center center",borderRadius:16,boxShadow:"0 2px 12px rgba(0,58,79,0.08)",display:"block"}}/>
